      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="p-8 bg-white/80 border border-forest/5 rounded-3xl flex flex-col justify-between hover:border-jade/20 transition-all duration-300 group">
            ...
            <div className="mt-8 pt-6 border-t border-forest/5 flex items-baseline">
              <AnimatedCounter value={30} suffix="%" prefix="-" />
              <span className="text-[10px] text-forest/40 tracking-wider font-bold uppercase ml-4">Chemical Use</span>
            </div>
          </div>
          ...
          <div className="p-8 bg-white/80 border border-forest/5 rounded-3xl flex flex-col justify-between hover:border-jade/20 transition-all duration-300 group">
            ...
            <div className="mt-8 pt-6 border-t border-forest/5 flex items-baseline">
              ...
              <span className="text-[10px] text-forest/40 tracking-wider font-bold uppercase ml-4">field Profit</span>
            </div>
          </div>
          ...
          <div className="p-8 bg-white/80 border border-forest/5 rounded-3xl flex flex-col justify-between hover:border-jade/20 transition-all duration-300 group">
            ...
            <div className="mt-8 pt-6 border-t border-forest/5 flex items-baseline">
              ...
              <span className="text-[10px] text-forest/40 tracking-wider font-bold uppercase ml-4">Yield Growth</span>
            </div>
          </div>
          ...
          <div className="p-8 bg-white/80 border border-forest/5 rounded-3xl flex flex-col justify-between hover:border-jade/20 transition-all duration-300 group">
            ...
            <div className="mt-8 pt-6 border-t border-forest/5 flex items-baseline">
              ...
              <span className="text-[10px] text-forest/40 tracking-wider font-bold uppercase ml-4">Payback Period</span>
            </div>
          </div>
