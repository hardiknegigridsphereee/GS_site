...
const blocksData: Record<string, BlockData> = {
  blockA: {
    ...
    cropName: "Honeycrisp crop Block",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
          <div>
            <div className="flex items-center gap-2 text-sm md:text-xl font-black tracking-[0.2em] text-jade uppercase mb-3">
              ...
              The Smart Field Advantage
            </div>
            <h2 className="text-3xl md:text-5xl font-black tracking-tight text-forest leading-tight mb-4">
              Crop Intelligence Cockpit
            </h2>
            <p className="text-base md:text-lg text-forest/70 max-w-2xl font-light leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
              ...
              <div className="relative z-10 w-full flex flex-col items-center">
                ...
                <div className="relative w-36 h-36 flex items-center justify-center mb-6">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-4xl font-black text-forest">{block.health}%</span>
                    <span className="text-[9px] font-bold text-forest/40 tracking-wider uppercase">Health Score</span>
                  </div>
                </div>

                <h4 className="text-xl font-bold text-forest mb-1">{block.name}</h4>
                <p className="text-xs text-jade font-semibold tracking-widest uppercase">{block.cropName}</p>
              </div>
            </div>

            {/* Environmental Sensors array */}
            <div className="bg-white/80 border border-forest/5 rounded-3xl p-6">
              <h5 className="text-xs font-bold tracking-widest text-forest/40 uppercase mb-4 flex items-center gap-1.5">
                <Layers className="w-3.5 h-3.5 text-jade" /> Live Sensors Array
              </h5>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-forest/5 border border-forest/5 p-4 rounded-2xl flex items-center gap-3">
                  <div className="p-2 bg-jade/10 text-jade rounded-lg">
                    <Thermometer className="w-4 h-4" />
                  </div>
                  <div>
                    <span className="text-[10px] text-forest/40 block uppercase tracking-wider">Air Temp</span>
                    <span className="text-sm font-bold text-forest">{block.temp}</span>
                  </div>
                </div>
                <div className="bg-forest/5 border border-forest/5 p-4 rounded-2xl flex items-center gap-3">
                  <div className="p-2 bg-jade/10 text-jade rounded-lg">
                  ...
                  <div>
                    <span className="text-[10px] text-forest/40 block uppercase tracking-wider">Humidity</span>
                    <span className="text-sm font-bold text-forest">{block.humidity}</span>
                  </div>
                </div>
                <div className="bg-forest/5 border border-forest/5 p-4 rounded-2xl flex items-center gap-3">
                  <div className="p-2 bg-jade/10 text-jade rounded-lg">
                  ...
                  <div>
                    <span className="text-[10px] text-forest/40 block uppercase tracking-wider">Wind</span>
                    <span className="text-sm font-bold text-forest">{block.wind}</span>
                  </div>
                </div>
                <div className="bg-forest/5 border border-forest/5 p-4 rounded-2xl flex items-center gap-3">
                  <div className="p-2 bg-jade/10 text-jade rounded-lg">
                  ...
                  <div>
                    <span className="text-[10px] text-forest/40 block uppercase tracking-wider">Solar Radiation</span>
                    <span className="text-sm font-bold text-forest">{block.solar}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="bg-white/80 border border-forest/5 rounded-3xl p-6 flex-1 flex flex-col justify-between">
              <div>
                <div className="flex justify-between items-center mb-6">
                  <h5 className="text-xs font-bold tracking-widest text-forest/40 uppercase flex items-center gap-1.5">
                    <Activity className="w-3.5 h-3.5 text-jade" /> AI Pathogen Matrices
                  </h5>
                  <span className="text-[9px] bg-forest/5 border border-forest/5 text-forest/60 px-2 py-0.5 rounded-md font-medium uppercase">
                    Confidence: 95%
                  </span>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs">
                      <span className="text-forest/80 font-medium">Fungal Infection</span>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs">
                      <span className="text-forest/80 font-medium">Fire Blight</span>
                  ...
                  <div className="space-y-1.5">
                    <div className="flex justify-between text-xs">
                      <span className="text-forest/80 font-medium">Powdery Mildew</span>
              ...
              <div className="border-t border-forest/5 pt-5 mt-6 flex gap-3 items-start bg-jade/5 p-4 rounded-2xl border border-jade/10">
            ...
            <div className="bg-white/80 border border-forest/5 rounded-3xl p-6 flex flex-col justify-between">
              <div>
                <h5 className="text-xs font-bold tracking-widest text-forest/40 uppercase mb-5 flex items-center gap-1.5">
                  <CloudRain className="w-3.5 h-3.5 text-jade" /> Soil Hydrology & Stress
                </h5>

                <div className="grid grid-cols-2 gap-6 mb-6">
                  <div>
                    <span className="text-[10px] text-forest/40 block uppercase tracking-wider mb-1">Soil Moisture</span>
                    <div className="flex items-baseline gap-1.5">
                      <span className="text-3xl font-black text-forest">{block.soilMoisture}%</span>
                      <span className="text-[10px] text-forest/50">VWC</span>
                    </div>
                    <span className="text-[10px] text-forest/40 block mt-1">{block.soilMoistureStatus}</span>
                  </div>

                  <div>
                    <span className="text-[10px] text-forest/40 block uppercase tracking-wider mb-1">Water Stress Index</span>
                ...
                <div className="flex justify-between text-[8px] text-forest/30 font-bold uppercase tracking-widest mt-1.5">
                  <span>0% Dry</span>
          ...
          <div className="lg:col-span-3 flex flex-col">
            ...
            <div className="bg-white/80 border border-jade/20 rounded-3xl p-6 flex-1 flex flex-col justify-between relative overflow-hidden shadow-2xl shadow-jade/5 min-h-[350px]">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-center border-b border-forest/5 pb-3.5 mb-5">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold tracking-widest text-forest uppercase">Intel-Ag Engine</span>
                  </div>
                ...
                <div className="text-[10px] text-forest/40 font-mono tracking-widest uppercase mb-1.5">Actionable Advice</div>
                ...
                <div className="text-xs text-forest/80 leading-relaxed font-mono mt-3 text-left">
              ...
              <div className="relative z-10 border-t border-forest/5 pt-5 mt-6">
