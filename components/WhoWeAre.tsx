...
const onboardingSteps: Step[] = [
  {
    ...
    description: "We evaluate your orchard's microclimate zone, block distribution, soil variance, and historical disease pressures."
  },
  {
    number: "02",
    icon: <Hammer className="w-5 h-5 text-black" />,
    title: "Install & Integrate",
    description: "We deploy the solar-powered GridSphere weather station directly in your orchard blocks, syncing sensors instantly."
  },
  {
    number: "03",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10 mb-20">
          ...
          <div className="max-w-2xl">
            <p className="text-base md:text-lg text-spotify-textSec leading-relaxed font-light">
              We combine robust meteorological hardware with custom disease prediction algorithms to secure apple orchard output, eliminate input guesswork, and maximize bottom-line profit.
            </p>
          </div>
        </div>
