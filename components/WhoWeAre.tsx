      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl md:text-4xl font-black tracking-tight text-forest leading-tight uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          {onboardingSteps.map((step, idx) => (
            ...
            >
              ...
              <div className="text-xs font-black tracking-widest text-jade mb-2 uppercase font-mono">
                Step {step.number}
              </div>
              <h3 className="text-lg font-black text-forest mb-4 uppercase group-hover:text-jade transition-colors leading-tight">
                {step.title}
              </h3>
              <p className="text-xs md:text-sm text-forest/70 leading-relaxed font-light max-w-sm">
                {step.description}
              </p>
            </m.div>
          ))}
