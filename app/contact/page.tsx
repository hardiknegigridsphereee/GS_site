      ...
      <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
        ...
        <div className="lg:col-span-5 space-y-10">
          ...
          <div className="space-y-6">
            <a href="tel:+918219765685" className="flex items-center gap-4 p-5 bg-canvas/5 border border-canvas/5 rounded-3xl hover:border-jade/20 transition-all duration-300 group">
              <div className="p-3.5 bg-jade/15 text-jade rounded-2xl group-hover:scale-105 transition-all">
                <Phone className="w-6 h-6" />
              </div>
              <div>
                <span className="text-[10px] text-canvas/40 block uppercase tracking-widest font-bold font-mono">Call Support</span>
                <span className="text-lg font-bold text-canvas group-hover:text-jade transition-colors">+91-8219765685</span>
              </div>
            </a>

            <a href="mailto:info@gridsphere.in" className="flex items-center gap-4 p-5 bg-canvas/5 border border-canvas/5 rounded-3xl hover:border-jade/20 transition-all duration-300 group">
              <div className="p-3.5 bg-jade/15 text-jade rounded-2xl group-hover:scale-105 transition-all">
                <Mail className="w-6 h-6" />
              </div>
              <div>
                <span className="text-[10px] text-canvas/40 block uppercase tracking-widest font-bold font-mono">Email Us</span>
                <span className="text-lg font-bold text-canvas group-hover:text-jade transition-colors">info@gridsphere.in</span>
              </div>
            </a>

            <div className="flex items-center gap-4 p-5 bg-canvas/5 border border-canvas/5 rounded-3xl">
              <div className="p-3.5 bg-jade/15 text-jade rounded-2xl">
                <MapPin className="w-6 h-6" />
              </div>
              <div>
                <span className="text-[10px] text-canvas/40 block uppercase tracking-widest font-bold font-mono">Location</span>
                <span className="text-lg font-bold text-canvas">Himachal Pradesh, India</span>
              </div>
            </div>
          </div>
        ...
        {/* Lead Form (7 Columns) */}
        <div className="lg:col-span-7 bg-black/40 border border-canvas/5 p-8 md:p-10 rounded-3xl relative overflow-hidden">
          ...
          <h3 className="text-2xl font-bold text-canvas mb-8 uppercase tracking-wide border-b border-canvas/5 pb-4">Consultation Request</h3>
          ...
          {submitted ? (
            <div className="py-12 text-center space-y-4">
              ...
              <h4 className="text-xl font-bold text-canvas">Advisory Request Submitted</h4>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-wider text-canvas/40 block">Your Name</label>
                  <input
                    type="text"
                    required
                    value={formState.name}
                    onChange={(e) => setFormState({ ...formState, name: e.target.value })}
                    className="w-full bg-canvas/5 border border-canvas/10 rounded-2xl px-5 py-3 text-sm text-canvas focus:outline-none focus:border-jade/50 font-light"
                    placeholder="Enter name"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-wider text-canvas/40 block">Phone Number</label>
                  <input
                    type="tel"
                    required
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-wider text-canvas/40 block">Number of Orchard Blocks</label>
                <input
                  type="number"
                  required
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase tracking-wider text-canvas/40 block">Message Details</label>
                <textarea
                  rows={4}
