...
export default function ProductPage() {
  return (
    <main className="relative bg-[#050505] min-h-screen text-canvas overflow-hidden">
      <Header />
      ...
      <section className="py-16 px-4 md:px-8 max-w-[1600px] mx-auto relative z-10">
        <div className="flex flex-col xl:flex-row gap-10 items-center justify-center">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="w-full max-w-[380px] xl:w-[350px] bg-[#0a0a0a] border border-canvas/10 rounded-[40px] p-6 shadow-2xl shadow-black relative overflow-hidden"
          >
            {/* Phone Notch */}
            ...
            <div className="mt-8 flex justify-between items-center mb-8">
              <span className="text-sm font-bold text-canvas uppercase tracking-wider">Field Protection</span>
              <ShieldCheck className="w-5 h-5 text-jade" />
            </div>

            <div className="space-y-6">
              {/* Risk Gauge */}
              <div className="bg-canvas/5 rounded-3xl p-6 border border-canvas/5 text-center shadow-inner">
                <span className="text-xs text-canvas/50 uppercase tracking-widest font-bold">Pest Activity Risk</span>
                <div className="relative w-36 h-36 mx-auto mt-5 flex items-center justify-center">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-4xl font-black text-canvas">50%</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-canvas/5 rounded-2xl p-5 border border-canvas/5">
                ...
                <div className="bg-canvas/5 rounded-2xl p-5 border border-canvas/5">
                  ...
                  <div className="w-full bg-black/50 h-2 rounded-full overflow-hidden"><div className="bg-honey h-full rounded-full w-[50%]" /></div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center transform transition-transform duration-700 group-hover:scale-105">
              {/* Anemometer top */}
              <div className="w-40 h-20 border-b-[6px] border-canvas/20 relative flex justify-center">
                <div className="absolute top-0 w-32 h-1.5 border border-canvas/40 animate-spin" style={{ animationDuration: '4s' }} />
                <div className="w-5 h-full bg-gradient-to-b from-white/80 to-white/20 rounded-t-md shadow-lg" />
              </div>
              {/* Rain Gauge */}
              <div className="w-20 h-16 bg-canvas/10 rounded-b-2xl border border-canvas/20 mt-3 backdrop-blur-md shadow-lg" />
              {/* Main Housing */}
              <div className="w-32 h-56 bg-gradient-to-br from-[#111] to-[#222] border border-canvas/20 rounded-[2rem] mt-6 flex flex-col items-center justify-center shadow-[0_0_60px_rgba(16,185,129,0.2)] relative overflow-hidden">
                ...
                <span className="text-xs font-black tracking-[0.2em] uppercase text-canvas/60">GridSphere</span>
            ...
            <div className="absolute bottom-4 text-center bg-black/40 backdrop-blur-md border border-canvas/10 px-8 py-4 rounded-3xl">
              <span className="text-sm font-bold tracking-[0.3em] text-jade uppercase block mb-1">The Master Array</span>
              <p className="text-xs text-canvas/50 max-w-xs mx-auto leading-relaxed">Physical node gathering raw environmental telemetry with aerospace-grade precision.</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="mt-8 flex justify-between items-center mb-8">
              <span className="text-sm font-bold text-canvas uppercase tracking-wider">Soil Health</span>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-jade/10 rounded-3xl p-5 border border-jade/20 text-center">
                  ...
                  <div className="text-3xl font-black text-canvas mt-2">6.5</div>
                </div>
                <div className="bg-canvas/5 rounded-3xl p-5 border border-canvas/5 text-center">
                  <span className="text-[10px] text-canvas/50 uppercase tracking-widest font-bold">EC (dS/m)</span>
                  <div className="text-3xl font-black text-canvas mt-2">0.8</div>
                </div>
              </div>

              {/* Carbon */}
              <div className="bg-canvas/5 rounded-2xl p-5 border border-canvas/5 flex justify-between items-center">
                <span className="text-xs font-bold text-canvas/70 uppercase tracking-wide">Organic Carbon</span>
                <span className="text-xl font-black text-canvas">0.75%</span>
              </div>

              {/* NPK Breakdown */}
              <div className="bg-canvas/5 rounded-3xl p-5 border border-canvas/5 space-y-4">
                <span className="text-[10px] text-canvas/40 uppercase tracking-widest font-bold mb-1 block">Macronutrients (Kg/ha)</span>
                
                <div className="flex justify-between items-center bg-black/40 p-3 rounded-xl border border-canvas/5">
              ...
              <div className="flex gap-3">
                <div className="flex-1 bg-canvas/5 rounded-2xl py-3 text-center border border-canvas/5 text-xs font-bold text-canvas/50 uppercase tracking-wide">Calcium</div>
                <div className="flex-1 bg-canvas/5 rounded-2xl py-3 text-center border border-canvas/5 text-xs font-bold text-canvas/50 uppercase tracking-wide">Magnesium</div>
              </div>
      ...
      <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-black tracking-tight uppercase text-canvas">Core Value Offerings</h2>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-spotify-card border border-canvas/5 rounded-[32px] p-8 hover:border-jade/30 transition-all group">
            ...
            <h3 className="text-xl font-bold uppercase mb-3 text-canvas tracking-wide">Data Depth</h3>
            <p className="text-sm text-spotify-textSec leading-relaxed">
              Capture unprecedented resolution with <strong className="text-canvas">7 Weather Parameters</strong> and <strong className="text-canvas">14 Soil Parameters</strong> continuously monitored.
            </p>
          </div>
          <div className="bg-spotify-card border border-canvas/5 rounded-[32px] p-8 hover:border-jade/30 transition-all group">
            <div className="p-4 bg-jade/5 rounded-2xl w-fit mb-6 group-hover:scale-110 transition-transform">
            ...
            <h3 className="text-xl font-bold uppercase mb-3 text-canvas tracking-wide">Active Defense</h3>
            <p className="text-sm text-spotify-textSec leading-relaxed">
              Pre-emptive alerts for <strong className="text-canvas">Fungal Protection</strong> and <strong className="text-canvas">Pest Protection</strong> before outbreaks structurally manifest.
            </p>
          </div>
          <div className="bg-spotify-card border border-canvas/5 rounded-[32px] p-8 hover:border-jade/30 transition-all group">
            <div className="p-4 bg-jade/5 rounded-2xl w-fit mb-6 group-hover:scale-110 transition-transform">
            ...
            <h3 className="text-xl font-bold uppercase mb-3 text-canvas tracking-wide">Resource Mgmt</h3>
            <p className="text-sm text-spotify-textSec leading-relaxed">
              Achieve precise <strong className="text-canvas">Spray Timing</strong> optimizations and strictly monitored <strong className="text-canvas">Soil Health</strong> applications.
            </p>
          </div>
          <div className="bg-spotify-card border border-canvas/5 rounded-[32px] p-8 hover:border-jade/30 transition-all group">
            <div className="p-4 bg-jade/5 rounded-2xl w-fit mb-6 group-hover:scale-110 transition-transform">
            ...
            <h3 className="text-xl font-bold uppercase mb-3 text-canvas tracking-wide">Core Tech</h3>
            <p className="text-sm text-spotify-textSec leading-relaxed">
              Driven by Edge Computing, our predictive models are <strong className="text-canvas">Completely AI Enabled</strong> for zero-latency execution.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 px-6 md:px-12 w-full bg-spotify-card border-y border-canvas/5 relative z-10 shadow-2xl overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center relative z-10">
          <div className="flex-1">
            ...
            <h2 className="text-4xl md:text-5xl font-black tracking-tight text-canvas uppercase leading-tight mb-6">
              Weather Intelligence Capabilities
            </h2>
          ...
          <div className="flex-1 w-full space-y-6">
            {/* Atmospheric */}
            <div className="bg-black/60 border border-canvas/5 rounded-3xl p-8 hover:border-canvas/10 transition-colors">
              ...
              <div className="flex flex-wrap gap-3">
                {['Humidity', 'Temperature', 'Light Intensity', 'Pressure', 'Wind', 'Rainfall'].map(p => (
                  <span key={p} className="bg-canvas/5 hover:bg-canvas/10 transition-colors text-canvas text-sm font-medium px-4 py-2 rounded-full border border-canvas/5">{p}</span>
                ))}
              </div>
            </div>
